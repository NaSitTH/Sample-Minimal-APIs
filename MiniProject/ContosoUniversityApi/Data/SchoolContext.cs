...
public class SchoolContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Enrollment>().HasData(
            ...
            new Enrollment { EnrollmentId = 7, StudentId = 3, CourseId = 1050, Grade = Grade.C },
            new Enrollment { EnrollmentId = 8, StudentId = 4, CourseId = 1050, Grade = Grade.C },
            ...
            new Enrollment { EnrollmentId = 11, StudentId = 6, CourseId = 1045, Grade = Grade.C },
